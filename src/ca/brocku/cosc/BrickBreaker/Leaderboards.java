...
/**
 * Leaderboard activity that displays all the high scores on a 
 * ListView on the screen. Displays local user scores and global
 * scores uploaded to the highscore database
 * 
 * @author Matt Hills
 */
public class Leaderboards extends Activity {
    ...
    /* (non-Javadoc)
     * Populates the listview with the high scores and sets
     * up other widgets 
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		//get serialized scores from the extras
		...
		//create and set adapter to our listview to display scores
    ...
    /**
     * Creates a new CustomListAdapter with the list of high scores, and
     * sets the listview adapter
     * @param scores the list of scores to display on the listview
     */
    ...
    /**
     * Spinner on item selected listener. When the user selects global
     * or local scores, the ListView is populated with the approriate
     * list of scores
     */
