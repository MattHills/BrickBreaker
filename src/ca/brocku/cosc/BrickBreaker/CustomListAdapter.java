...
/**
 * A custom list adapter that is used to create a custom View
...
public class CustomListAdapter extends ArrayAdapter<Score> {
    ...
    /**
     * Creates a new CustomListAdapter that extents ArrayAdapter.
     * Added functionality includes the list of scores and a new
     * highscore to add
     * 
     * @param context current app context
     * @param resource view resource
     * @param scores list of high scores for this view
     * @param newScore new score to add to the list of high scores
     */
    ...
    /* (non-Javadoc)
     * Populates the TextView with the high scores to be displayed
     * 
